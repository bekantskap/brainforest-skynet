...
const Stats = () => {
  return (
    <section className="bg-primarycolor col-span-12 sm:col-span-6 lg:col-span-3  2xl:w-[321px] min-h-[440px]">
      <h2 className="text-xl m-2">Stats</h2>
      <div className="grid grid-cols-4 gap-4">
        <div className="relative flex items-center justify-center col-span-4 sm:col-span-2">
